...
STOCK_LIST_FILE = './assets/investment_targets/investment_targets.pkl'
...
if __name__ == '__main__':
    ...
    stock_list = get_stock_list_from_pkl(STOCK_LIST_FILE)  # 从Pickle文件读取股票列表
